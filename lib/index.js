...
var raf = require('raf');
var fluzo_store = require('./store')(postal);
...
var Fluzo = {
   ...
   action: fluzo_store.action,
   channel: fluzo_channel,
   Store: fluzo_store,

   Mixin: _.extend(React.addons.LinkedStateMixin, {
   ...
   clearRenderSubscriptions: function () {
      render_suscriptions = [];
   },
